 ...
 * and keeps the text in the HTML for search; with JS the body glides open.
 */
  ...
  return (
    <section className="border-t border-lake-line bg-[#ECE7DC]">
      <div className={`${frame} py-10 md:py-14`}>
        ...
        >
          {/* Padding, not margin, so nothing collapses while the height animates. */}
          <div className="max-w-4xl pt-6">
            ...
            <div className="border-t border-lake-line">
              {groups.map((g) => (
                <SmoothDetails
                  key={g.key}
                  className="group/item border-b border-lake-line"
                  summary={
