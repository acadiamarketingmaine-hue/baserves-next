...
const locationsByState: { state: string; icon: string; locations: LocationItem[] }[] = [
  {
    ...
    locations: [
      { name: 'Bankhead National Forest', href: '/bankhead-national-forest', image: '/images/bankhead-bicycle-trail.jpg', blurb: '2 recreation areas', children: [
  ...
  },
  {
    ...
    locations: [
      { name: 'Canal Bridge Campground', href: '/experiences/canal-bridge', image: '/images/canal-bridge/beach-1.jpg', blurb: '36 sites on the Saco River' },
    ],
  },
  {
    state: 'Michigan',
  ...
  },
  {
    ...
    locations: [
      { name: 'Meramec State Park', href: '/experiences/meramec-state-park', image: '/images/meramec-state-park/cabin-2.jpg', blurb: 'Lodging, dining, watercraft' },
  ...
  },
  {
    ...
    locations: [
      { name: 'Burlingame State Park', href: '/experiences/burlingame-state-park', image: '/images/Burlingame2-1536x1152.jpg', blurb: '755 sites, 20 cabins' },
    ],
  },
  {
    state: 'West Virginia',
    ...
    locations: [
      { name: 'Monongahela National Forest', href: '/monongahela-national-forest', image: '/images/monongahela/spruce-knob-panorama.jpg', blurb: '6 campgrounds', children: [
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between h-14 px-6">
            ...
            <div className="flex items-center gap-8">
              <Link href="/" aria-label="BA Services home" className="flex items-center min-h-[44px] min-w-[44px]">
                <Image
                  src="/images/logo.png"
                  alt="BA Services"
                  width={140}
        ...
        >
          ...
          <div className="bg-stone-100 border-b border-stone-200">
            <div className="flex items-center justify-between px-6 py-4">
              <Link href="/" aria-label="BA Services home" onClick={() => setMobileMenuOpen(false)} className="flex items-center min-h-[44px] min-w-[44px]">
                <Image
                  src="/images/logo.png"
                  alt="BA Services"
                  width={120}
            ...
            <div className="px-6 pb-4 space-y-2">
              ...
              <a
                ...
                className="min-h-[44px] flex items-center justify-center gap-2 py-1.5 text-gray-500 text-sm"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div key={group.state}>
                    ...
                    {group.locations.map((loc) => (
                      <div key={loc.href}>
                        <Link
                          href={loc.href}
                          className="min-h-[44px] flex items-center gap-3 py-2 pl-2 text-gray-600 text-sm"
                          onClick={() => setMobileMenuOpen(false)}
                        >
                        ...
                        {loc.children?.map((child) => (
                          <Link
                            key={child.href}
                            href={child.href}
                            className="min-h-[44px] flex items-center gap-3 py-1.5 pl-6 text-gray-500 text-sm"
                            onClick={() => setMobileMenuOpen(false)}
                          >
                ...
                {secondaryNavLinks.map((item) => (
                  item.external ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="min-h-[44px] flex items-center justify-between py-2.5 text-gray-600 text-sm"
                    >
                      {item.name}
