...
export const tipsawLakeRecreationArea: PropertyContent = {
  ...
  gallery: [
    { src: '/images/tipsaw-lake/lake-view.jpg', alt: 'Picnic shelter among bare winter trees at Tipsaw Lake' },
    ...
    { src: '/images/tipsaw-lake/campsite2.jpg', alt: 'RV campsites along a paved campground loop' },
    { src: '/images/tipsaw-lake/entrance.jpg', alt: 'Tipsaw Lake Recreation Area entrance sign' },
    { src: '/images/tipsaw-lake/twin-oaks.jpg', alt: 'Twin Oaks picnic shelter' },
      ...
      items: [
        {
          ...
          photo: { src: '/images/tipsaw-lake/twin-oaks.jpg', alt: 'Twin Oaks picnic shelter' },
        },
        {
