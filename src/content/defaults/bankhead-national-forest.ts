...
export const bankheadNationalForest: PropertyContent = {
  ...
  paragraphs: [
    ...
    'The Bankhead Ranger District offers a wide range of recreational opportunities, supported by the region\'s mild climate. Peak visitation typically runs from mid-March through late October. Campground seasons vary, so check dates for Clear Creek and Corinth on Recreation.gov before planning an off-season trip. Visitors can enjoy camping, picnicking, boating, water sports, hiking, mountain biking, horseback riding, off-highway vehicle (OHV) use, fishing, hunting, photography, and scenic driving.',
