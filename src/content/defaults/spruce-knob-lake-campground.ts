...
export const spruceKnobLakeCampground: PropertyContent = {
  ...
  paragraphs: [
    ...
    'Spruce Knob Lake Campground includes 28 standard campsites, 2 double sites, and 12 walk-in tent sites. Standard sites are equipped with paved spurs, picnic tables, fire rings, and lantern posts. A developed host site provides solar-powered electricity, water, and a sewage holding tank. Sanitary facilities consist of five single-unit vault restrooms, all of which are accessible. Trash dumpsters are available throughout the campground for waste disposal.',
