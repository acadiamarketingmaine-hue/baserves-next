...
const SLUG = 'stuart-recreation-area'
...
// The words live in src/content/defaults/stuart-recreation-area.ts. Only the
// icons stay here - they are JSX and cannot be serialised.

export default async function StuartRecreationAreaPage() {
  const content = (await getPropertyContent(SLUG))!
  ...
  return (
    <main className="min-h-screen">
      <Navigation />
      <PageSchema
        url="/monongahela-national-forest/stuart-recreation-area"
