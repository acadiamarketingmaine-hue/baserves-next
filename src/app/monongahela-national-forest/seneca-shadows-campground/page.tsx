...
const SLUG = 'seneca-shadows-campground'
...
// The words live in src/content/defaults/seneca-shadows-campground.ts. Layout is
// the shared Lakeside campground template (kit-v2 rollout) — see
// src/components/pages/monongahela/CampgroundTemplate.tsx.

export default async function SenecaShadowsCampgroundPage() {
  const content = (await getPropertyContent(SLUG))!
