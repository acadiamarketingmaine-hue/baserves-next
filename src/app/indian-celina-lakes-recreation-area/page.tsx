...
// The words and photos live in
// src/content/defaults/indian-celina-lakes-recreation-area.ts. Only the icons
// stay here - they are JSX and cannot be serialised - and they are matched to
// the activity copy by key.
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">{content.sections.culturalAndNatural.heading}</h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  {content.sections.culturalAndNatural.paragraphs?.[0]}
                </p>

                <h3 className="text-2xl font-bold text-gray-900 mb-3">{content.sections.operationsAndAccess.heading}</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                  {content.sections.operationsAndAccess.paragraphs?.[0]}
                </p>
                <p className="text-gray-600 leading-relaxed">
                  {content.sections.operationsAndAccess.paragraphs?.[1]}
                </p>
              </div>
            </div>
