...
const categoryData: Record<string, any> = {
  'kayak-and-watercraft-rentals': {
    ...
    experiences: [
      ...
      { name: 'Tipsaw Lake Boating', location: 'Tipsaw Lake Recreation Area, Perry County, IN', duration: 'Hourly / Daily', price: 'From $20', image: '/images/DSC_0001-2048x1365.jpg', href: '/tipsaw-lake-recreation-area' },
  ...
  'campground-rentals': {
    ...
    experiences: [
      ...
      { name: 'Hardin Ridge Recreation Area', location: 'Monroe County, IN', duration: 'Nightly', price: '200+ sites', image: '/images/DSC_0103-2048x1365.jpg', href: '/hardin-ridge-recreation-area' },
  ...
  'hiking': {
    ...
    experiences: [
      ...
      { name: 'Hardin Ridge Trails', location: 'Monroe County, IN', duration: '12+ miles', price: 'Free', image: '/images/DSC_0103-2048x1365.jpg', href: '/hardin-ridge-recreation-area' },
