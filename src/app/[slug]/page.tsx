          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-forest-DEFAULT rounded-2xl p-6 text-white">
                ...
                <a href={`tel:${(content.phone || site.phone).replace(/[^+\d]/g, '')}`} className="flex items-center justify-center gap-2 mt-4 text-white/90 hover:text-white transition-colors">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
